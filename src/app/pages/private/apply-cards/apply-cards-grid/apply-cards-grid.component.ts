...
@Component({
  selector: 'app-apply-cards-grid',
  templateUrl: './apply-cards-grid.component.html',
  styleUrls: ['./apply-cards-grid.component.scss'],
})
export class ApplyCardsGridComponent implements OnInit, OnChanges, OnDestroy {
